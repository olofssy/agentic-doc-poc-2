...
`docs/current/` contains the current project requirements and implementation
context. `docs/archive/` preserves superseded material for historical reference
only. `docs/human-zone/` holds informal notes and human-maintained summaries.

Current authoritative project brief:
